...
3. \`curl_cffi\` consulta la API oficial de inventario para España.
...
El método de adquisición de cookies de Akamai con \`nodriver\` y las llamadas con
\`curl_cffi\` está adaptado de
